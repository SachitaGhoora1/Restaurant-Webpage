...
const body = document.querySelector("body"),
    ...
    mainHeaderSection = document.querySelector("header"),
...
const headerSection = document.querySelector(".header-section"); // No change here, keeping the original declaration
...
// home page JS
if (pageTitle.text === "Island Spice Heaven") {
